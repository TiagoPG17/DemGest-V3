...
<head>
    ...
    <title>{{ config('app.name', 'DemGest') }} - Iniciar Sesión</title>
...
<body class="font-sans antialiased bg-gray-100">
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <h1 class="text-center text-3xl font-bold text-indigo-800">DemGest</h1>
            <h2 class="mt-2 text-center text-sm text-gray-600">Sistema de Gestión Demográfica</h2>
        </div>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 text-center text-sm text-gray-500">
                        ...
                        <p class="mt-2">Email: <span class="font-medium text-indigo-600">admin@demogest.com</span></p>
                        <p>Contraseña: <span class="font-medium text-indigo-600">password</span></p>
                    </div>
                </div>
            </div>
        </div>
