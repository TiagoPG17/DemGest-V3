...
<head>
    ...
    <title>{{ config('app.name', 'GHconnecting') }} - Confirmar Contraseña</title>
            ...
            <div class="bg-white/10 backdrop-blur-lg shadow-2xl rounded-2xl p-8 space-y-6 border border-white/20">
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
                    ...
                    <div class="flex justify-end pt-2">
                        <button type="submit" class="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-xl transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-transparent shadow-lg">
                            Confirmar
                        </button>
                    </div>
                </form>
